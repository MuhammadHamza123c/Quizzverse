      ...
      <div className="min-h-screen py-24 px-4">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="flex gap-3 mt-6">
            <button onClick={handleExport} className="btn-primary flex-1 flex items-center justify-center gap-2 py-3">
              <Download className="w-4 h-4" /> Export JSON
            </button>
            <Link href="/dashboard" className="btn-primary flex-1 flex items-center justify-center gap-2 py-3">
              Dashboard
            </Link>
            <Link href="/rooms/create" className="btn-primary flex-1 flex items-center justify-center gap-2 py-3">
              New Room
            </Link>
          </div>
        </div>
